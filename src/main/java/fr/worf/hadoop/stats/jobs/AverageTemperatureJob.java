...
import fr.worf.hadoop.stats.reducers.AverageReducer;
 ...
 */
/**
 * Effectue une moyenne sur une colonne hbase
 *
...
public class AverageTemperatureJob extends Configured implements Tool {
    ...
    public AverageTemperatureJob() throws IOException {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TableMapReduceUtil.initTableMapperJob("meteo:stations", scan, TemperatureMapper.class, Text.class, IntWritable.class, job);

        TableMapReduceUtil.initTableReducerJob("meteo:results", AverageReducer.class, job);
